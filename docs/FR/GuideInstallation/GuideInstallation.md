...
1. Connectez-vous à l'adresse [http://192.168.10.1:3000](http://192.168.10.1:3000) à l'aide de votre navigateur Internet.
...
1. Cliquez sur l'onglet Configuration dans le menu du haut. Vous obtiendrez une page telle que montré à la Figure 22. Sur cette page, il faut configurer dans l'ordre (les informations pour chaque champ seront visibles si vous videz le texte qu'ils contiennent):
